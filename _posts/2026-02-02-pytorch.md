...
## The implementation of a **Multi-Variable Linear Regression** model using PyTorch. The goal is to train a model that predicts a single output value ($y$) from three input variables ($x_1, x_2, x_3$).
